...
const { intmateBalanceReport, transactionSummaryReport, tuckShopSalesReport, wageDistributionReport, quickStatistics, inventoryStockHistoryReport } = require('../controllers/reportController');
...
router.post("/intimate-balance-report", attachLocationFilter, intmateBalanceReport);
